            ...
            children: [
                  {
                    ...
                    file: [
                      {
                        url: '/AlphaSparseLib/Alphasparse/Hygon-DCU/spmv/csr/single/spmv_csr_s_dist_dcu.png',
                        name: 'spmv_csr_s_dist_dcu.png',
                      },
                      {
                        url: '/AlphaSparseLib/Alphasparse/Hygon-DCU/spmv/csr/single/spmv_csr_s_pdf_dcu.png',
                        name: 'spmv_csr_s_pdf_dcu.png',
                      },
                      {
                        url: '/AlphaSparseLib/Alphasparse/Hygon-DCU/spmv/csr/single/spmv_csr_s_bestAlg_dcu.png',
                        name: 'spmv_csr_s_bestAlg_dcu.png',
                      },                      
                    ],
                    dataSource: [
                      {
                        url: '/AlphaSparseLib/Alphasparse/Hygon-DCU/spmv/csr/single/spmv_csr_s_dcu.csv',
                  ...
                  },
                  {
                    ...
                    file: [
                      {
                        url: '/AlphaSparseLib/Alphasparse/Hygon-DCU/spmv/csr/double/spmv_csr_d_dist_dcu.png',
                        name: 'spmv_csr_d_dist_dcu.png',
                      },
                      {
                        url: '/AlphaSparseLib/Alphasparse/Hygon-DCU/spmv/csr/double/spmv_csr_d_pdf_dcu.png',
                        name: 'spmv_csr_d_pdf_dcu.png',
                      },
                      {
                        url: '/AlphaSparseLib/Alphasparse/Hygon-DCU/spmv/csr/double/spmv_csr_d_bestAlg_dcu.png',
                        name: 'spmv_csr_d_bestAlg_dcu.png',
                      },                      
                    ],
                    dataSource: [
                      {
                        url: '/AlphaSparseLib/Alphasparse/Hygon-DCU/spmv/csr/double/spmv_csr_d_dcu.csv',
